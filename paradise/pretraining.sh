...
OUTDIR=/home/jupyter/afromt/paradise/pretrainining_output_En_Ln_Only
PRETRAIN=/home/jupyter/afromt/paradise/pretrainining_output_En_Ln_Only/checkpoint_best.pt
mkdir -p $OUTDIR/log
echo $HOME;
